...
# Draw nodes with custom node colors and sizes
node_colors = [location_colors.get(location.split()[0], 'skyblue') for location in df['Location']]
node_size = 250
nx.draw_networkx_nodes(G, pos, node_color=node_colors, node_size=node_size)

# Draw edges with custom edge colors
